...
@Composable
fun LoginScreen(loginViewModel: LoginViewModel, onNavigate: () -> Unit) {
    ...
    Column(
        ...
        Text("Inicia sesión o regístrate", color = Color.Gray, style = MaterialTheme.typography.titleMedium)
